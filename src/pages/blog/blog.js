  ...
  data() {
    return {
      article : [
        ...
        {
          id: 5,
          img: require('@/assets/img/video(4).png'),
          title: 'Lampirkan dokumen resmi dari Otoritas Jasa Keuangan (OJK)',
          desc: 'Para pengunjung Company Page AdaPundi sekalian',
          date: '04 Agustus 2020',
          visit: 125,
        },
        {
          id: 6,
          img: require('@/assets/img/video(5).png'),
          title: 'AdaPundi mengucapkan Selamat Hari Raya Waisak 2564 BE / 2020 M',
          desc: 'Stay safe, stay healthy, dan marilah kita bersama sukseskan protokol Pemerintah RI terkait Covid-19,',
          date: '04 Agustus 2020',
          visit: 125,
        },
        {
          id: 7,
          img: require('@/assets/img/video(6).png'),
          title: 'Darmin: Fintech Adalah Pekerjaan Masa Depan',
          desc: 'Para konsumen Ada Pundi sekalian... Di jaman dahulu kala, bisa bekerja di dunia perbankan',
          date: '04 Agustus 2020',
          visit: 125,
        }
      ],
